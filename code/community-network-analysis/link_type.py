# cluster analysis by classify the edges between clusters into two categories
# collaboration and transfer. thenm creates two corresponding pajek networks
# this script takes the summary network file for the network, and other pajek network files as inputs
import sys, itertools, json

# give a prefix for accumulative network
prefix = sys.argv[1]
...
output1 = open(prefix + '_collaboration.net', 'wb')
output2 = open(prefix + '_transfer.net', 'wb')
vec_output1 = open(prefix + '_collaboration.vec', 'wb')
