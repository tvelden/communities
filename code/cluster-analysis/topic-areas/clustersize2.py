...
ids = "/Users/shiyansiadmin/Dropbox/Files/Field2DataSS3/DirectCitationNetworkGiantComponent.net" # Giantcomponent 
labels = "/Users/shiyansiadmin/Dropbox/Files/Field2DataSS3/DirectCitationNetworkGiantComponent_Synthe2.clu" # partition file
inputfile = "/Users/shiyansiadmin/Dropbox/Files/Field2DataSS3/in.txt" #input file
outfile = "/Users/shiyansiadmin/Dropbox/Files/Field2DataSS3/clustersize.txt"
top = 11 # top X area
IDmatchLabel = {}
...
for i in clustercount:
    out.write("DC" + str(i) + "\t" + str(clustercount[i])+"\n")
out.close()